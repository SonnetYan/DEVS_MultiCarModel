...
public trafficControlSys_DA(){
    this("trafficControlSys", model_configData.generator_eastMoving_lambda, new Random(model_configData.randSeed_eastMoving),
    		...
    		model_configData.pf_carPassingTime_mean, new Random(model_configData.randSeed_IntersectionM), 0, 0);
}
...
public trafficControlSys_DA(String nm, double eastMoving_lambda, Random eastMoving_rand, double westMoving_lambda, Random westMoving_rand,
		String tfcState, double sgm, double remainGreenT, int westSideQSize, int eastSideQSize, double carPassingTime, Random interSection_rand, double lightSwitchTime_E2W, double lightSwitchTime_W2E){
    super(nm);
    this.addOutport("out");
    ...
    trafficControlModel IntersectionModel = new trafficControlModel("trafficControlModel", tfcState, sgm, remainGreenT, 
    		westSideQSize, eastSideQSize, carPassingTime, interSection_rand, lightSwitchTime_E2W, lightSwitchTime_W2E);

...
public trafficControlModel(String name,int QWestSideSize, int QEastSideSize){
    this(name,"eastMoving_passive", DevsInterface.INFINITY, 
    		0, QWestSideSize, QEastSideSize,model_configData.carPassingTime_mean, new Random(model_configData.randSeed_IntersectionM));
}
...
//	if(this.getSimulationTime() > 3000) {
//
//		model_configData.maxElapseTimeWhenBusy_E2W = 60;
//	}
//
//	double incrementPerSecond = 1.0 / (5000 - 3000); // 计算每秒增加的量
//	if(this.getSimulationTime() < 1600) {
//		carPassingTime_mean = model_configData.carPassingTime_mean;
//
//		//model_configData.maxElapseTimeWhenBusy_W2E =
//		model_configData.maxElapseTimeWhenBusy_E2W = 100;
//	}
//	else if(this.getSimulationTime() < 3000) {
//		carPassingTime_mean = model_configData.carPassingTime_mean;
//		model_configData.maxElapseTimeWhenBusy_W2E = 60;
//		model_configData.maxElapseTimeWhenBusy_E2W = 100;
//
//	}
//	else if(this.getSimulationTime() < 5000) {
//		carPassingTime_mean = model_configData.carPassingTime_mean - incrementPerSecond* (this.getSimulationTime() - 3000);
//		model_configData.maxElapseTimeWhenBusy_W2E = 60;
//		model_configData.maxElapseTimeWhenBusy_E2W = 80;
//	}
//	else {
//		model_configData.maxElapseTimeWhenBusy_W2E = 60;
//		model_configData.maxElapseTimeWhenBusy_E2W = 80;
...
protected void applyTrafficControlRules() {
	if(trafficLightState.startsWith("eastMoving")) { 							// eastMoving is green
		if(!queue_eastSide.isEmpty()&&(queue_westSide.isEmpty() 
				||elapsedTimeInGreen>=model_configData.maxElapseTimeWhenBusy_W2E )) 	// need to change signal
		...
		if(!queue_westSide.isEmpty() && (queue_eastSide.isEmpty()
				|| elapsedTimeInGreen>=model_configData.maxElapseTimeWhenBusy_E2W))	//need to change signal

...
public void  simulate_TN(double timeTN){
	double randomNumPrecisionBuffer = 0.00000001; // a temporary solution to deal with the double variable precision problem
	  int i=1;
	  tN = nextTN();
	  while( tN <= (timeTN+randomNumPrecisionBuffer) ) {
//	    Logging.log("ITERATION " + i + " ,time: " + tN, Logging.full);
//	    System.out.println(" ------------ ITERATION " + i +" tN "+tN);
	    computeInputOutput(tN);
	    //showOutput();
